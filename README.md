# 🎓 Tech Learning & Course Completions

This repository serves as a centralized portfolio for my continuous professional development, technical course completions, and learning milestones in DevOps, Data Engineering, and Architecture.
...
*   **Building, Deploying, and Monitoring Your First Apache NiFi Dataflow** 
    *   *Completed:* February 8, 2026 | [View Certificate](./pluralsight/1705bc8c-eba4-41df-8374-b5404d789298.pdf)
...
*   **Build and Manage dbt Models** 
    *   *Completed:* January 18, 2026 | [View Certificate](./pluralsight/2c9e9c49-4813-464b-9bc0-3fb984390e3e.pdf)
*   **Amazon Kinesis Deep Dive** 
    *   *Completed:* January 17, 2026 | [View Certificate](./pluralsight/ecd5a59f-d307-430a-960e-a39fe2caf6ea.pdf)
...
*   **Building ETL Pipelines from Streaming Data with Kafka and ksqlDB** 
    *   *Completed:* September 9, 2025 | [View Certificate](./pluralsight/028325fe-e5db-49b9-b5cd-c84b2d2befe3.pdf)
...
*   **ETL Processes and Tools for Data Engineers** 
    *   *Completed:* August 12, 2025 | [View Certificate](./pluralsight/31b72dfa-c969-4a4f-a2e8-47e80e354181.pdf)
...
*   **Hands-on with Terraform on AWS** 
    *   *Completed:* June 29, 2025 | [View Certificate](./pluralsight/305c4622-e42a-4652-91ae-5f1e963bab55.pdf)
...
*   **AWS Certified Data Engineer - Associate (DEA-C01): Data Security and Governance** 
    *   *Completed:* April 13, 2025 | [View Certificate](./pluralsight/01846002-226e-43e7-9833-99ba34ff07d7.pdf)
...
1. Open the platform folder above (e.g., `/udemy` or `/pluralsight`).
2. Click on the corresponding `.pdf` or `.png` file to view the certificate of completion.
